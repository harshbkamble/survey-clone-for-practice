...
//                   <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Survey</span>
//               </a>
...
//                           <li>
//                               <a href="#" className="text-gray-900 dark:text-white hover:underline" aria-current="page">Designer</a>
//                           </li>
//                           <li>
//                               <a href="#" className="text-gray-900 dark:text-white hover:underline">Preview</a>
//                           </li>
//                           <li>
//                               <a href="#" className="text-gray-900 dark:text-white hover:underline">Json Editor</a>
//                           </li>
